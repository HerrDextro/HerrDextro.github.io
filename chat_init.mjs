...
const messages = [
  {
    content: "You are a helpful AI agent helping Neo and other users to find the best information he needs for his job",
    role: "system",
  },
];
...
let selectedModel = "Qwen1.5-0.5B-chat-q4f32_1"; //used to be: Llama-3-8B-Instruct-q4f32_1-MLC-1k
